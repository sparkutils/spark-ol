#!/bin/bash
# spark-ol comprehensive e2e validation: stage our OpenLineage Spark build
# plus its compile/runtime deps into /databricks/jars so the listener class,
# the OpenLineage java client and its own runtime deps are on the driver
